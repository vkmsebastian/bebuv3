...
export const SystemContext = createContext({} as ReturnType<typeof useSystemContextLogic>);
...
export function useSystemContextLogic() {
    ...
    useLayoutEffect(() => {
        const targetDate = new Date(process.env.NEXT_PUBLIC_TARGET_DATE || '2025-01-24');
