...
import { NotyfContext, useNotyfLogic } from './contexts/NotyfContext';
...
export default function RootLayout({
    ...
    const notyfContextValue = useNotyfLogic();
    const { playbackData, nowPlayingNotyfRef } = playerContextValue;
    const { notyf } = notyfContextValue;
        ...
        <html lang="en">
            <body className="bg-white dark:bg-black dark:text-white overflow-hidden antialiased">
                <SystemContext.Provider value={systemContextValue}>
                    <NotyfContext.Provider value={notyfContextValue}>
